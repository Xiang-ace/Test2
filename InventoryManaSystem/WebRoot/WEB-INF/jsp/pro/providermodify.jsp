		...
		<form id="providerForm" name="providerForm" method="post"
			...
			<div>
				<label for="proContact">联系人：</label> <input type="text"
					...
					value="${provider.providerContact }"> <font color="red"></font>
			</div>

			<div>
				<label for="proPhone">联系电话：</label> <input type="text"
					name="proPhone" id="proPhone" value="${provider.providerPhone }">
				<font color="red"></font>
			</div>
			...
			<div>
				<label for="proFax">传真：</label> <input type="text" name="proFax"
					id="proFax" value="${provider.providerFax }">
			</div>

			<div>
				<label for="proDesc">描述：</label> <input type="text" name="proDesc"
					id="proDesc" value="${provider.providerDesc }">
			</div>
...
<script type="text/javascript"
	src="${path}/statics/js/providermodify.js"></script>
